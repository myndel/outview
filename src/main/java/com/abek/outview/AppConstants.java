...
public class AppConstants {
	...
	public static final String	PROPERTIES_DEV_FILE_NAME		= "application.dev.properties";

	public static final String	PROPERTY_MAIL_PROTOCOL			= "connection.protocol";
	...
	public static final String	PROPERTY_FILTER_FROM			= "filter.from";

	public static final String	FILTER_WITH_PJ					= "WITH";
	public static final String	FILTER_WITHOUT_PJ				= "WITHOUT";
